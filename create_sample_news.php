...
try {
    ...
    $sampleNews = [
        ...
        [
            ...
            'content' => '<p>Berikut adalah jadwal libur nasional pada bulan Februari 2025:</p><ul><li>14 Februari 2025 - Hari Valentine (bukan libur nasional)</li><li>17 Februari 2025 - Tahun Baru Imlek</li><li>28 Februari 2025 - Isra Miraj Nabi Muhammad SAW</li></ul><p>Selama hari libur nasional, kegiatan belajar mengajar akan diliburkan. Siswa diharapkan memanfaatkan waktu libur untuk belajar di rumah.</p>',
            'category' => 'libur',
            'type' => 'announcement',
            'status' => 'published',
            'is_featured' => false,
        ...
        [
            ...
            'content' => '<p>Dengan hormat, kami informasikan bahwa jadwal ujian tengah semester genap tahun ajaran 2024/2025 mengalami perubahan sebagai berikut:</p><p><strong>Jadwal Lama:</strong> 15-20 Maret 2025<br><strong>Jadwal Baru:</strong> 22-27 Maret 2025</p><p>Perubahan jadwal ini dilakukan karena adanya kegiatan lomba tingkat kabupaten yang akan diikuti oleh siswa-siswi SMP Negeri 01 Namrole.</p><p>Atas perhatian dan kerjasamanya, kami ucapkan terima kasih.</p>',
            'category' => 'jadwal',
            'type' => 'announcement',
            'status' => 'published',
            'is_featured' => false,
    ...
    foreach ($sampleNews as $newsData) {
        ...
        echo "Created news: {$news->title}\n";
    }

    echo "\nTotal news created: " . count($sampleNews) . "\n";
    echo "Total news in database: " . News::count() . "\n";
    echo "Published news: " . News::where('status', 'published')->count() . "\n";

} catch (\Exception $e) {
    echo "Error: " . $e->getMessage() . "\n";
}

echo "\n=== END CREATE SAMPLE NEWS ===\n";
?>
