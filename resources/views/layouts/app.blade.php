        ...
        <header class="bg-primary-500 shadow-lg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <nav class="hidden lg:flex space-x-6">
                    ...
                    <a href="{{ route('academic-calendar.index') }}" class="text-white hover:text-primary-200 px-3 py-2 rounded-md text-sm font-medium transition-colors">Kalender</a>
                    ...
                    <a href="{{ route('gallery.index') }}" class="text-white hover:text-primary-200 px-3 py-2 rounded-md text-sm font-medium transition-colors">Galeri</a>
                    <a href="{{ route('documents.index') }}" class="text-white hover:text-primary-200 px-3 py-2 rounded-md text-sm font-medium transition-colors">Download</a>
                    <a href="{{ route('contact') }}" class="text-white hover:text-primary-200 px-3 py-2 rounded-md text-sm font-medium transition-colors">Kontak</a>
                </nav>
                ...
                <div class="lg:hidden hidden" id="mobile-menu">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-primary-600 rounded-lg mt-2">
                        ...
                        <a href="{{ route('academic-calendar.index') }}" class="text-white hover:text-primary-200 block px-3 py-2 rounded-md text-base font-medium">Kalender</a>
                        ...
                        <a href="{{ route('gallery.index') }}" class="text-white hover:text-primary-200 block px-3 py-2 rounded-md text-base font-medium">Galeri</a>
                        <a href="{{ route('documents.index') }}" class="text-white hover:text-primary-200 block px-3 py-2 rounded-md text-base font-medium">Download</a>
                        <a href="{{ route('contact') }}" class="text-white hover:text-primary-200 block px-3 py-2 rounded-md text-base font-medium">Kontak</a>
