...
@section('page-description', 'Kelola dan verifikasi pendaftaran siswa baru')
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    <a href="{{ route('ppdb.panitia.export', request()->query()) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors flex items-center justify-center text-sm sm:text-base">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-500">Data Pendaftaran</span>
                    </div>
                </li>
            </ol>
        </nav>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('ppdb.panitia.show', $registration) }}" class="text-blue-600 hover:text-blue-900 p-1 rounded" title="Lihat Detail">
...
function updateStatus(registrationId, currentStatus) {
    document.getElementById('statusForm').action = `/ppdb/panitia/registrations/${registrationId}/status`;
...
function deleteRegistration(registrationId, studentName) {
    if (confirm(`Apakah Anda yakin ingin menghapus pendaftaran PPDB untuk ${studentName}?`)) {
        ...
        form.method = 'POST';
        form.action = `/ppdb/panitia/registrations/${registrationId}`;
