            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              ...
                              placeholder="Deskripsikan tugas ini">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="instructions" id="instructions" rows="4" 
                              ...
                              placeholder="Berikan instruksi yang jelas untuk siswa">{{ old('instructions') }}</textarea>
                    @error('instructions')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="points" id="points" value="{{ old('points', 100) }}" min="1"
                    ...
                    <div>
                        ...
                        <input type="number" name="late_penalty" id="late_penalty" value="{{ old('late_penalty', 0) }}" min="0" max="100"
