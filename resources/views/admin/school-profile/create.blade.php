...
@section('page-title', 'Buat Profil Sekolah')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Form Profil Sekolah</h3>
            <p class="text-sm text-gray-500">Isi informasi lengkap tentang sekolah</p>
        </div>
        
        <form action="{{ route('admin.school-profile.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="established_year" id="established_year" value="{{ old('established_year') }}" 
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="vision" id="vision" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 @error('vision') border-red-500 @enderror" required>{{ old('vision') }}</textarea>
                        @error('vision')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="mission" id="mission" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 @error('mission') border-red-500 @enderror" required>{{ old('mission') }}</textarea>
                        @error('mission')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <textarea name="history" id="history" rows="5" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 @error('history') border-red-500 @enderror" required>{{ old('history') }}</textarea>
                    @error('history')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="headmaster_name" id="headmaster_name" value="{{ old('headmaster_name') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="headmaster_position" id="headmaster_position" value="{{ old('headmaster_position') }}" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="headmaster_education" id="headmaster_education" value="{{ old('headmaster_education') }}" 
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="accreditation_status" id="accreditation_status" value="{{ old('accreditation_status') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="accreditation_number" id="accreditation_number" value="{{ old('accreditation_number') }}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="accreditation_year" id="accreditation_year" value="{{ old('accreditation_year') }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="accreditation_score" id="accreditation_score" value="{{ old('accreditation_score') }}" 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="accreditation_valid_until" id="accreditation_valid_until" value="{{ old('accreditation_valid_until') }}" 
