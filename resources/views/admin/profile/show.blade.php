...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-xl shadow-lg text-white p-6">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:block">
                <a href="{{ route('admin.profile.edit') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('admin.profile.edit') }}" class="text-primary-600 hover:text-primary-700 font-medium">
                    Edit
                </a>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-semibold text-gray-900">Informasi Sistem</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center p-4 bg-blue-50 rounded-xl">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1">{{ \App\Models\User::students()->count() }}</p>
            ...
            <div class="text-center p-4 bg-green-50 rounded-xl">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1">{{ \App\Models\User::teachers()->count() }}</p>
            ...
            <div class="text-center p-4 bg-purple-50 rounded-xl">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1">{{ \App\Models\Course::count() }}</p>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200">
            ...
            <a href="{{ route('admin.profile.edit') }}" class="flex items-center p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200">
            ...
            <a href="{{ route('admin.dashboard') }}" class="flex items-center p-4 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors duration-200">
                <i class="fas fa-users text-purple-600 text-xl mr-3"></i>
                <div>
                    <p class="font-medium text-purple-900">Dashboard Admin</p>
                    <p class="text-sm text-purple-600">Kelola sistem</p>
                </div>
            </a>
            
            <a href="{{ route('admin.dashboard') }}" class="flex items-center p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors duration-200">
                <i class="fas fa-cog text-orange-600 text-xl mr-3"></i>
                <div>
                    <p class="font-medium text-orange-900">Dashboard Admin</p>
                    <p class="text-sm text-orange-600">Kelola sistem</p>
                </div>
            </a>
        </div>
    </div>
