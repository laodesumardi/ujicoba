...
@section('title', 'Kelola Home Sections')
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-2xl sm:text-3xl font-bold">Kelola Home Sections</h1>
                    <p class="text-primary-100 mt-2 text-sm sm:text-base">Kelola bagian-bagian yang ditampilkan di halaman utama</p>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.home-sections.create') }}" class="bg-white text-primary-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-50 transition-colors flex items-center text-sm sm:text-base">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-4 sm:px-6 py-4 border-b border-gray-200">
                <h3 class="text-base sm:text-lg font-semibold text-gray-900">Daftar Home Sections</h3>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.home-sections.show', $section) }}" class="text-blue-600 hover:text-blue-900 p-1 rounded" title="Lihat">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                        </svg>
                                    </a>
                                    <a href="{{ route('admin.home-sections.edit', $section) }}" class="text-yellow-600 hover:text-yellow-900 p-1 rounded" title="Edit">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </a>
                                    <form method="POST" action="{{ route('admin.home-sections.destroy', $section) }}" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus section ini?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada home sections</h3>
                                <p class="mt-1 text-sm text-gray-500">Belum ada home sections yang dibuat.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="lg:hidden">
                ...
                <div class="border-b border-gray-200 p-4">
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex-1">
                            <div class="text-sm font-medium text-gray-900 mb-1">{{ $section->section_key }}</div>
                            <div class="text-sm text-gray-600 mb-2">{{ $section->title ?? 'No title' }}</div>
                            <div class="text-xs text-gray-500">Order: {{ $section->sort_order }}</div>
                        </div>
