                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4" 
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="requirements" id="requirements" rows="6" 
                                          ...
                                          placeholder="Masukkan persyaratan pendaftaran...">{{ old('requirements') }}</textarea>
                                @error('requirements')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="schedule" id="schedule" rows="6" 
                                          ...
                                          placeholder="Masukkan jadwal penting...">{{ old('schedule') }}</textarea>
                                @error('schedule')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="technical_guide" id="technical_guide" rows="6" 
                                          ...
                                          placeholder="Masukkan petunjuk teknis...">{{ old('technical_guide') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="faq" id="faq" rows="6" 
                                          ...
                                          placeholder="Masukkan FAQ...">{{ old('faq') }}</textarea>
                                @error('faq')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
