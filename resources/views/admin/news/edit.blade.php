    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-2xl font-bold text-primary-900 mb-6">Edit Berita</h2>
                ...
                <form method="POST" action="{{ route('admin.news.update', $news) }}" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <img src="{{ $news->featured_image_url }}" alt="{{ $news->title }}" 
                                         ...
                                         onerror="this.src='{{ asset('images/default-news.png') }}'">
                                    <div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="author_name" id="author_name" value="{{ old('author_name', $news->author_name) }}" 
                            ...
                            <div>
                                ...
                                <input type="email" name="author_email" id="author_email" value="{{ old('author_email', $news->author_email) }}" 
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="tags" id="tags" value="{{ old('tags', $news->tags ? implode(', ', $news->tags) : '') }}" 
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Pinned -->
                            <div class="flex items-center">
                                <input type="checkbox" name="is_pinned" id="is_pinned" value="1" {{ old('is_pinned', $news->is_pinned) ? 'checked' : '' }}
                                       class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
