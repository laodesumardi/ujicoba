    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h2 class="text-2xl font-bold text-primary-900 mb-6">Edit Sosial Media</h2>
                ...
                <form method="POST" action="{{ route('admin.social-media.update', $socialMedia) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $socialMedia->name) }}" 
                        ...
                        <div>
                            ...
                            <input type="url" id="url" name="url" value="{{ old('url', $socialMedia->url) }}" 
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-3">
                                <input type="color" id="color" name="color" value="{{ old('color', $socialMedia->color) }}" 
                                       class="w-12 h-10 border border-gray-300 rounded cursor-pointer @error('color') border-red-500 @enderror">
                                <input type="text" id="color_text" value="{{ old('color', $socialMedia->color) }}" 
                        ...
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $socialMedia->sort_order) }}" 
                        ...
                        <div class="md:col-span-2">
                            <div class="flex items-center">
                                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $socialMedia->is_active) ? 'checked' : '' }}
