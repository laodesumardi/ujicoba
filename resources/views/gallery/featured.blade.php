...
@section('title', 'Galeri Unggulan - SMP Negeri 01 Namrole')
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-bold mb-4">Galeri Unggulan</h1>
                <p class="text-xl text-primary-100">Koleksi galeri terbaik dari SMP Negeri 01 Namrole</p>
            </div>
        </div>
    </div>
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-gray-700 font-medium">Unggulan</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada galeri unggulan</h3>
                    <p class="mt-1 text-sm text-gray-500">Belum ada galeri yang ditandai sebagai unggulan.</p>
                </div>
            @endif
        </div>
    </div>
