...
@section('title', 'Daftar - SMP Negeri 01 Namrole')
...
<div class="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-primary-900 mb-2">Buat Akun Admin</h2>
            <p class="text-primary-600">Daftar untuk mengakses dashboard admin</p>
        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" 
                               ...
                               autofocus 
                               autocomplete="name"
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" 
                               ...
                               required 
                               autocomplete="new-password"
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors @error('password_confirmation') border-red-500 @enderror"
